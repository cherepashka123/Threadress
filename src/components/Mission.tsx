  ...
  return (
    <section ref={ref} className="relative min-h-[60vh] py-16 bg-white">
      <div className="max-w-3xl mx-auto px-6 text-center">
        <h2
          className="text-2xl sm:text-3xl md:text-4xl font-light mb-6 sm:mb-8 text-purple-700 font-serif"
        ...
        <div className="mb-8">
          <p
            className="text-base sm:text-lg md:text-xl text-gray-800 leading-relaxed font-serif"
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:gap-4 justify-center items-center w-full max-w-lg mx-auto">
          <button
            className="w-full sm:w-auto px-6 sm:px-7 py-3 border border-purple-300 text-purple-700 rounded-full font-serif bg-white hover:bg-purple-50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-purple-200"
            style={{ fontFamily: 'Playfair Display, serif' }}
          >
            Discover Boutiques
          </button>
          <button
            className="w-full sm:w-auto px-6 sm:px-7 py-3 border border-gray-300 text-gray-700 rounded-full font-serif bg-white hover:bg-gray-50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-200"
            style={{ fontFamily: 'Playfair Display, serif' }}
          >
            Join Beta
          </button>
